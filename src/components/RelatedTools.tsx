...
const related: Record<string, string[]> = {
  ...
  'xml-formatter': ['json-formatter', 'sql-formatter', 'yaml-formatter', 'html-formatter'],
  'sql-formatter': ['json-formatter', 'xml-formatter', 'json-to-csv', 'diff-checker'],
  'css-formatter': ['css-gradient', 'color-converter', 'html-formatter', 'js-formatter'],
  'html-formatter': ['css-formatter', 'js-formatter', 'xml-formatter', 'meta-tag'],
  'js-formatter': ['json-formatter', 'html-formatter', 'css-formatter', 'sql-formatter'],
  // 编解码类
  'base64': ['url-encode', 'hash-generator', 'html-entity', 'jwt-decoder'],
  'url-encode': ['html-entity', 'base64', 'json-formatter', 'my-ip'],
  'html-entity': ['url-encode', 'base64', 'regex', 'markdown-editor'],
  'jwt-decoder': ['base64', 'hash-generator', 'json-formatter', 'url-encode'],
  ...
  'bcrypt-generator': ['hash-generator', 'password-generator', 'base64', 'random-number'],
  // 生成器类
  'qrcode': ['url-encode', 'base64-image', 'image-compressor', 'color-converter'],
  'uuid-generator': ['hash-generator', 'password-generator', 'timestamp', 'random-number'],
  'password-generator': ['hash-generator', 'bcrypt-generator', 'uuid-generator', 'random-number'],
  'cron-generator': ['timestamp', 'uuid-generator', 'random-number', 'number-base'],
  'lorem-ipsum': ['word-count', 'markdown-editor', 'random-number', 'text-dedup'],
  'regex': ['diff-checker', 'word-count', 'json-formatter', 'html-entity'],
  'markdown-editor': ['word-count', 'markdown-to-html', 'html-entity', 'lorem-ipsum'],
  'random-number': ['password-generator', 'uuid-generator', 'number-base', 'bcrypt-generator'],
  // 转换类
  'timestamp': ['uuid-generator', 'cron-generator', 'password-generator', 'number-base'],
  'color-converter': ['css-gradient', 'qrcode', 'css-formatter', 'json-formatter'],
  'json-to-csv': ['json-formatter', 'sql-formatter', 'yaml-formatter', 'number-base'],
  ...
  'number-base': ['color-converter', 'hash-generator', 'timestamp', 'cron-generator'],
  'markdown-to-html': ['markdown-editor', 'html-formatter', 'json-formatter', 'html-entity'],
  'css-gradient': ['color-converter', 'css-formatter', 'svg-to-png', 'image-converter'],
  // 文本工具
  'word-count': ['case-converter', 'markdown-editor', 'text-dedup', 'lorem-ipsum'],
  'text-dedup': ['word-count', 'case-converter', 'diff-checker', 'regex'],
  'diff-checker': ['regex', 'word-count', 'text-dedup', 'case-converter'],
  // 查询工具
  'my-ip': ['dns-lookup', 'user-agent', 'url-encode', 'email-validator'],
  'user-agent': ['my-ip', 'dns-lookup', 'email-validator', 'meta-tag'],
  'email-validator': ['user-agent', 'my-ip', 'regex', 'password-generator'],
  // 网络工具
  'dns-lookup': ['my-ip', 'user-agent', 'email-validator', 'url-encode'],
  // SEO工具
  'meta-tag': ['html-formatter', 'user-agent', 'json-formatter', 'url-encode'],
  // 图像/其他
