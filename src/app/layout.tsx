        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: 'MoreToolbox',
              url: 'https://moretoolbox.com',
              description: '免费在线开发者工具集合，包含Schema生成器、SERP预览、SEO检查器、百分比计算、JSON↔XML转换、JSON转TypeScript、API Key生成、Slug生成、Chmod计算、HTML转Markdown、CSS渐变生成、图片格式转换、DNS查询、Meta标签生成、JSON格式化、JWT解码、Cron表达式、进制转换、Bcrypt等75+款实用工具。',
