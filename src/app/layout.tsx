...
export const metadata: Metadata = {
  ...
  description: 'MoreToolbox 提供46+款免费在线开发者工具：JSON格式化、CSS渐变生成、Box Shadow生成、颜色调色板、HTML Playground、图片格式转换、DNS查询、Meta标签生成、JWT解码、密码强度检查、HTTP状态码参考、URL解析、Cron表达式生成器、进制转换器、Bcrypt密码哈希、SQL格式化、时间戳转换、二维码生成、IP查询、Base64编解码、HTML/JS格式化等。全部在浏览器本地处理，数据安全，无需注册。 | 46+ free online developer tools: JSON formatter, CSS gradient, box shadow, color palette, HTML playground, image converter, DNS lookup, JWT decoder, password strength checker, HTTP status codes, URL parser, QR code generator, Base64 encoder & more. All browser-side, secure, no registration.',
  keywords: ['在线工具', '开发者工具', '免费在线工具', 'JSON格式化', 'CSS渐变生成', 'Box Shadow生成', '颜色调色板', 'HTML Playground', '图片格式转换', 'DNS查询', 'Meta标签生成', '密码强度检查', 'HTTP状态码', 'URL解析', 'User Agent解析', 'SVG转PNG', 'JWT解码器', 'Cron表达式', '进制转换', 'Bcrypt', 'SQL格式化', '时间戳转换', '二维码生成', '正则表达式', 'Base64编解码', 'IP地址查询', 'XML格式化', 'YAML格式化', 'HTML格式化', 'JS格式化', 'CSV转JSON', 'UUID生成器', '密码生成器', '文本对比', '邮箱验证', '在线前端工具'],
  openGraph: {
    title: 'MoreToolbox - 免费在线开发者工具集合 | JSON格式化、二维码、Base64',
    description: '46+款免费在线开发者工具，CSS渐变、Box Shadow、颜色调色板、HTML Playground、图片格式转换、DNS查询、Meta标签、JSON、Cron等。 | 46+ free online dev tools. No registration.',
